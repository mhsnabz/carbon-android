...
public class discoverUser implements Parcelable
{
    ...
    public discoverUser(String name, String username, String insta, String twitter, String snap, String github, String profileImage, String skils, String job, String uid, int age) {
        this.name = name;
